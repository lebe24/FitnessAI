          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            if (profile.ageString.isNotEmpty) ...[
              ...
              Text(profile.ageString,
                  style: GoogleFonts.poppins(fontSize: 14, color: AppPalete.whiteColor.withValues(alpha: 0.7))),
            ],
          ])),
        ]));
      },
  ...
  Widget _shell({required Widget child}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppPalete.borderColor.withValues(alpha: 0.2)),
      ),
      child: child,
    );
  }
