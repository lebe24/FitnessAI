...
import 'package:fitness/ui/features/analytic/views/training_volume_chart.dart';
      ...
      body: SafeArea(
        child: CustomScrollView(
          ...
          slivers: [
            ...
            // ── Training volume ───────────────────────────────────────────────
            // Replaces the session list that was here. The list restated what
            // the session detail already shows; volume over time answers
            // whether the training is going anywhere, which nothing did.
            SliverToBoxAdapter(
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16),
