...
class BaseStepLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isFirstStep = vm.step == OnboardingStep.gender;
    ...
    return SafeArea(
      child: Padding(
        ...
        child: Column(
          children: [
            // Back button row — hidden on the first step
            Align(
              ...
              child: AnimatedOpacity(
                ...
                child: GestureDetector(
                  onTap: isFirstStep ? null : () => vm.previousStep(),
                  child: Container(
  ...
  double progressForContext(BuildContext context) {
    final step = context.read<OnboardingViewModel>().step;
    switch (step) {
