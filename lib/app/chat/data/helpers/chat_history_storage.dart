...
class ChatHistoryStorage {
  ...
  static String _getStorageKey(String userId, DateTime date) {
  ...
  /// Load chat messages for a specific date
  ...
  static Future<void> clearChatHistory(String userId, DateTime date) async {
    try {
      final box = await _boxInstance;
      final key = _getStorageKey(userId, date);
